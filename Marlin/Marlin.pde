...
// Start message print control  7/23/12          -jkl
static boolean stateIsConnected = false;  // causes message to print when connected to pronterface
static boolean stateIsStarted = false;    // causes message to print when started and connected
...
void process_commands()
{
  ...
  else if(code_seen('M'))
  {
    ...
    case 92: // M92
      ...
      break;
    case 115: // M115
    // Message modified and expanded. 7/23/12  -jkl
      SerialprintPGM(MSG_M115_REPORT);
      SerialprintPGM(MSG_MARLIN);
      SerialprintPGM(VERSION_STRING);
      #ifdef STRING_VERSION_CONFIG_H
        #ifdef STRING_CONFIG_H_AUTHOR
          SerialprintPGM(STRING_VERSION_CONFIG_H);

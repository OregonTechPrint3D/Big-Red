...
#define Y_STEP_PIN         4  // HugoMax#1 mod
#define Y_DIR_PIN          5  // HugoMax#1 mod
#define Y_ENABLE_PIN       10 // HugoMax#1 mod
//#define Y_MIN_PIN           20
#define Y_MIN_PIN          37
#define Y_MAX_PIN          -1

#define Z_STEP_PIN         6  // HugoMax#1 mod
#define Z_DIR_PIN          7  // HugoMax#1 mod
#define Z_ENABLE_PIN       11 // HugoMax#1 mod
#define Z_MIN_PIN          36
#define Z_MAX_PIN          -1
